...
//             <div className="bg-gray-800 p-6 rounded-lg shadow-lg w-full h-[300px] flex flex-col">
...
//                                 <div
//                                     className={`flex items-center p-3 rounded-lg cursor-pointer transition-all duration-200 bg-gray-700 ${selectedPlatform === platform && isLinked
...
//                     pauseOnHover: true,
//                     draggable: true,
//                     // Removed theme: "dark" to use default (adapts to system/theme)
//                 });
//             } catch (error) {
//                 toast.error(`Failed to link ${platform} handle`, {
//                     position: "top-right",
