export function PlatformLogo({ platform }: { platform: string }) {
    switch (platform.toUpperCase()) {
        case "CODECHEF":
            // return <img src="https://cdn.codechef.com/images/cc-logo.svg" alt="CodeChef Logo" className="h-8 w-auto" />;
            return <img src="https://th.bing.com/th/id/ODLS.3508ec8f-159f-41da-b501-2cbbc5af2261?w=32&amp;h=32&amp;qlt=90&amp;pcl=fffffa&amp;o=6&amp;pid=1.2" height="32" width="32" alt="Global web icon" className=" rounded-full rms_img" data-bm="43"></img>
        case "CODEFORCES":
            return (
                <img
        ...
        default:
            return (
                <p className="text-gray-50">"N/A"</p>
            );
    }
}